...
namespace GTAVisionUtils
{
    ...
    {
        [DllImport("GTAVisionNative.asi", EntryPoint = "export_get_depth_buffer", CharSet = CharSet.Unicode,
            CallingConvention = CallingConvention.Cdecl)]
        public static extern int GetDepthBuffer(out IntPtr buf);

        [DllImport("GTAVisionNative.asi", EntryPoint = "export_get_color_buffer", CharSet = CharSet.Unicode,
            CallingConvention = CallingConvention.Cdecl)]
